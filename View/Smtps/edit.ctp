<?php //debug($_SESSION); ?>
<?php $this->set('title_for_layout', __('Modifica Indirizzo')); ?>
<?php $this->set('active', 'smtp'); ?>
<?php $this->Html->addCrumb('Indirizzi Invio', '/smtps/index'); ?>
<?php $this->Html->addCrumb(h($this->request->data['Smtp']['email']), '/smtps/view/'.$this->request->data['Smtp']['id']); ?>
<?php $this->Html->addCrumb('Modifica', '/smtps/edit/'.$this->request->data['Smtp']['id']); ?>
<div class="main-header clearfix">
	<div class="headline">
		<h3 class="no-margin"><?php echo __('Modifica Indirizzo di Invio'); ?></h3>
