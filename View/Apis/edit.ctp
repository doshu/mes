<?php $this->set('title_for_layout', __('Modifica Chiave API')); ?>
<?php $this->Html->addCrumb('Gestione API', '/apis/index'); ?>
<?php $this->Html->addCrumb('Modifica Chiave', '/apis/edit/'.$this->request->data['Api']['id']); ?>
<div class="main-header clearfix">
	<div class="headline">
		<h3 class="no-margin"><?php echo __('Modifica Chiave API').' '.h($this->request->data['Api']['name']); ?></h3>
